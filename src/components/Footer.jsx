...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300 border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        
        {/* Grid de secciones */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          
          {/* Sección 1: Para Proveedores */}
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/login" className="hover:text-rose-400 transition-colors flex items-center">
                  <span className="mr-2">🔐</span>
                  Acceder a mi cuenta
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm mb-4">
              <li className="flex items-start">
                <span className="mr-2">📧</span>
                <a href="mailto:info@mensajeparati.com" className="hover:text-rose-400 transition-colors">
                  info@mensajeparati.com
                </a>
              </li>
              <li className="flex items-start">
                <span className="mr-2">📱</span>
            ...
            <div className="flex space-x-3 mt-4">
              <a href="#" className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-600 hover:border-rose-400 hover:text-rose-400 transition-all">
              ...
              <a href="https://github.com/mihifidem" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-600 hover:border-rose-400 hover:text-rose-400 transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 pt-6 mt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm text-gray-400">
            <div className="mb-4 sm:mb-0">
              <span className="block sm:inline">© {new Date().getFullYear()} WeMe - Mensajes con emoción</span>
